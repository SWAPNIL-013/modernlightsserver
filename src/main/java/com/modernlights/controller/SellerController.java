...
import com.modernlights.config.JwtProvider;
...
import com.modernlights.repository.VerificationCodeRepository;
import com.modernlights.response.ApiResponse;
import com.modernlights.response.AuthResponse;
import com.modernlights.service.*;
import com.modernlights.service.impl.CustomeUserServiceImplementation;
import com.modernlights.utils.OtpUtils;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Modern Lights Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Modern Lights Email Verification Code";
        String text = "Welcome to Modern Lights, verify your account using this link ";
